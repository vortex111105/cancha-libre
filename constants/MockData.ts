...
export type Sport = 'Fútbol 5vs5' | 'Fútbol 7vs7' | 'Fútbol 8vs8' | 'Fútbol 11vs11' | 'Básquet 3x3' | 'Básquet 5x5' | 'Pádel Single (1vs1)' | 'Pádel Parejas';
...
export const TEAMS: Team[] = [
  ...
  },
  {
    ...
    avatar: '🦒',
    color: '#EC4899',
    description: 'Equipo de básquet competitivo, entrenamos martes y jueves.',
    availableDays: ['Martes', 'Jueves', 'Sábado'],
    rating: 4.8,
  },
  {
    ...
    avatar: '🎾',
    color: '#14B8A6',
    description: 'Pareja de pádel buscando torneos y partidos amistosos.',
...
export const FIELDS = [
  {
    ...
    distance: 1.8,
    price: 8500,
    sports: ['Fútbol 5vs5', 'Fútbol 7vs7'],
    rating: 4.7,
    available: true,
  },
  {
  ...
  },
  {
    ...
    distance: 0.5,
    price: 6000,
    sports: ['Fútbol 5vs5', 'Fútbol 7vs7', 'Fútbol 11vs11'],
    rating: 4.2,
    available: false,
  },
];
